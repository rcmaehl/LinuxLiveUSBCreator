[![Build Status](https://img.shields.io/github/actions/workflow/status/rcmaehl/LinuxLiveUSBCreator/lili.yml)](https://github.com/rcmaehl/LinuxLiveUSBCreator/actions?query=workflow%3Alili)
