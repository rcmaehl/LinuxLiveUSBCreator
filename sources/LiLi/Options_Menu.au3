...
Func GUI_Options_Menu()
	...
	$copyright = GUICtrlCreateLabel(Translate("CopyLeft by")&" Robert Maehl + Thibaut Lauzière - ",  15, 380, 250, 17,$SS_RIGHT)
	$licence=GUICtrlCreateLabel(Translate("GPL v3 License"), 265, 379, 360, 17)
